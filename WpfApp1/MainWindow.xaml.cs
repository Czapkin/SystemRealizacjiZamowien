...
namespace WpfApp1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            start:    // na razie niech bedzie goto
            MySqlConnector mysql = new MySqlConnector
                  ("SERVER=localhost;DATABASE=db_system_realizacji_zamowien_posilkow_12042020;UID=root;PASSWORD=CHUJKurwa");
            ...
            {
                MessageBoxResult result = MessageBox.Show("Failed connecting to database\nTry again?", "ERROR",MessageBoxButton.YesNo);
                switch (result)
                {
                    case MessageBoxResult.Yes:
                        goto start;    // niech bedzie na razie na goto
                        break;
